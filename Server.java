...
import java.awt.*;                    //FOR COLOR AND STUFF
import javax.swing.*;				  //FOR FRAME BUILDING
...
public class Server implements ActionListener{//implements belongs to awt event 
...
//		p1.setBackground(Color.GREEN);
		...
		p2 = new JPanel();
		p2.setBounds(5,75,440,565);
		f.add(p2);  
		
		text = new JTextField();
		text.setBounds(10,650,340,40);
		text.setFont(new Font("SAN_SERIF", Font.PLAIN,16));
		f.add(text);
		
		JButton send = new JButton("Send");
		send.setBounds(360,650,70,40);
